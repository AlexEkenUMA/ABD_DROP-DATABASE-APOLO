CREATE OR REPLACE PACKAGE PK_GESTION_CLIENTES AS
    ...
    PROCEDURE ELIMINAR_AUTORIZADO (IDE NUMBER, ID_EMPRESA NUMBER, TIPO_AUTO VARCHAR2);
...
CREATE OR REPLACE PACKAGE BODY PK_GESTION_CLIENTES AS
    ...
    BEGIN 
        ...
        COMMIT;
        EXCEPTION
            WHEN CLIENTE_YA_ENCONTRADO THEN
                INSERT INTO LOG_ERRORES VALUES ('CLIENTE_YA_ENCONTRADO', 'EXECEPCION DURANTE LA EJECUCION DE
                DAR_ALTA EN PK_CLIENTES: CLIENTE YA ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE ;
            WHEN TIPO_NO_VALIDO THEN 
            INSERT INTO LOG_ERRORES VALUES ('TIPO_NO_VALIDO', 'EXECEPCION DURANTE LA EJECUCION DE
                DAR_ALTA EN PK_CLIENTES: TIPO NO VALIDO',
                SYSDATE);
                COMMIT;
                RAISE TIPO_NO_VALIDO;
        ...
        COMMIT;
         EXCEPTION
            WHEN CLIENTE_NO_ENCONTRADO THEN
                ...
                MODIFICAR CLIENTE EN PK_CLIENTES: CLIENTE NO ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE CLIENTE_NO_ENCONTRADO;
    ...
    BEGIN
        ...
        COMMIT;
         EXCEPTION
            WHEN CLIENTE_NO_ENCONTRADO THEN
                INSERT INTO LOG_ERRORES VALUES ('CLIENTE_NO_ENCONTRADO', 'EXECEPCION DURANTE LA EJECUCION DE
                BAJA CLIENTE EN PK_CLIENTES: CLIENTE NO ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE CLIENTE_NO_ENCONTRADO;
             
            WHEN CUENTAS_ABIERTAS THEN
                INSERT INTO LOG_ERRORES VALUES ('CUENTAS_ABIERTAS', 'EXECEPCION DURANTE LA EJECUCION DE
                BAJA CLIENTE EN PK_CLIENTES: CLIENTE QUE SE INTENTA DAR DE BAJA TIENE CUENTAS ABIERTAS',
                SYSDATE);
                COMMIT;
                RAISE CUENTAS_ABIERTAS;
    ...
    BEGIN
        ...
        COMMIT;
          EXCEPTION
            WHEN CLIENTE_NO_ENCONTRADO THEN
                INSERT INTO LOG_ERRORES VALUES ('CLIENTE_NO_ENCONTRADO', 'EXECEPCION DURANTE LA EJECUCION DE
                AÑADIR AUTORIZADOS EN PK_CLIENTES: CLIENTE NO ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE CLIENTE_NO_ENCONTRADO;
                
            WHEN TIPOAUT_NO_VALIDO THEN
                INSERT INTO LOG_ERRORES VALUES ('TIPOAUT_NO_VALIDO', 'EXECEPCION DURANTE LA EJECUCION DE
                AÑADIR AUTORIZADOS EN PK_CLIENTES: TIPO DE AUTORIZACIÓN NO VALIDA',
                SYSDATE);
                COMMIT;
                RAISE TIPOAUT_NO_VALIDO;
    ...
    BEGIN 
        ...
        IF FILA LIKE '1' AND NOM IS NOT NULL THEN
    ...
    COMMIT;
    EXCEPTION
            WHEN PERSONA_AUTORIZADA_NO_ENCONTRADO THEN
                INSERT INTO LOG_ERRORES VALUES ('PERSONA_AUTORIZADA_NO_ENCONTRADO', 'EXECEPCION DURANTE LA EJECUCIÓN DE
                MODIFICAR AUTORIZADO EN PK_CLIENTES: PERSONA AUTORIZADA NO ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE PERSONA_AUTORIZADA_NO_ENCONTRADO;
                
            WHEN AUTORIZACION_NO_ESTA THEN
                INSERT INTO LOG_ERRORES VALUES ('AUTORIZACION_NO_ESTA', 'EXECEPCION DURANTE LA EJECUCIÓN DE
                MODIFICAR AUTORIZADO EN PK_CLIENTES: AUTORIZACIÓN NO ESTÁ',
                SYSDATE);
                COMMIT;
                RAISE AUTORIZACION_NO_ESTA;
    ...
    BEGIN
        ...
        FROM AUTORIZACIÓN
        WHERE EMPRESA_ID = ID_EMPRESA AND PERSONA_AUTORIZADA_ID = IDE AND TIPO = TIPO_AUTO;
        ...
        EXCEPTION
            WHEN PERSONA_AUTORIZADA_NO_ENCONTRADO THEN
                INSERT INTO LOG_ERRORES VALUES ('PERSONA_AUTORIZADA_NO_ENCONTRADO', 'EXECEPCION DURANTE LA EJECUCIÓN DE
                BAJA AUTORIZADO EN PK_CLIENTES: PERSONA AUTORIZADA NO ENCONTRADO',
                SYSDATE);
                COMMIT;
                RAISE PERSONA_AUTORIZADA_NO_ENCONTRADO;
                
            WHEN AUTORIZACION_NO_ENCONTRADA THEN
                INSERT INTO LOG_ERRORES VALUES ('AUTORIZACION_NO_ENCONTRADA', 'EXECEPCION DURANTE LA EJECUCIÓN DE
                BAJA AUTORIZADO EN PK_CLIENTES: AUTORIZACIÓN NO ENCONTRADA',
                SYSDATE);
                COMMIT;
                RAISE AUTORIZACION_NO_ENCONTRADA;
